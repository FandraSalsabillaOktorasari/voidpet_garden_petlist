    ...
    <header class="bg-gray-800 border-b border-gray-700 p-6 mb-8 shadow-sm">
        <div class="max-w-7xl mx-auto">
            ...
            <nav class="flex space-x-4 overflow-x-auto pb-2">
                ...
                <a href="{{ route('people.index') }}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium border border-gray-700 shadow-inner shrink-0">People (Food Tracking)</a>
