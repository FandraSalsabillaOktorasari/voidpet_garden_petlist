...
<head>
    ...
    <title>Voidpet Garden - Edit Pet</title>
...
<body class="bg-gray-900 text-gray-200 min-h-screen pb-12 font-sans">
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gray-800 rounded-xl shadow-2xl border border-gray-700/50 overflow-hidden">
            ...
            <form action="{{ route('pets.update', $pet->id) }}" method="POST" class="p-8 space-y-6" autocomplete="off">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nickname" value="{{ old('nickname', $pet->nickname) }}" placeholder="Leave empty for default" class="w-full bg-gray-900 focus:bg-gray-700 p-3 rounded-lg text-white border border-gray-600 focus:border-purple-500 transition-all outline-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="form-element-display" readonly placeholder="Select Species first..." class="w-full bg-gray-900/50 cursor-not-allowed p-3 rounded-lg text-gray-400 border border-gray-700 outline-none">
                        <span class="text-xs text-gray-500 mt-1 block">Element is automatically determined by Species and Vivid Form.</span>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-400 mb-2">Vivid Form (Optional)</label>
                ...
                <div class="grid grid-cols-2 gap-6 pt-4 border-t border-gray-700/50">
                    <div>
                        ...
                        <input type="number" name="stage" value="{{ old('stage', $pet->stage) }}" min="1" placeholder="e.g. 1" required class="w-full bg-gray-900 focus:bg-gray-700 p-3 rounded-lg text-white border border-gray-600 outline-none transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-400 mb-2">Level <span class="text-red-400">*</span></label>
                        <input type="number" name="level" value="{{ old('level', $pet->level) }}" min="1" placeholder="e.g. 1" required class="w-full bg-gray-900 focus:bg-gray-700 p-3 rounded-lg text-white border border-gray-600 outline-none transition-colors">
                    </div>
                </div>
                ...
                <div class="pt-6 border-t border-gray-700/50">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="intensity" value="{{ old('intensity', $pet->intensity) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-purple-500 transition-colors">
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Clarity</label>
                            <input type="number" name="clarity" value="{{ old('clarity', $pet->clarity) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-purple-500 transition-colors">
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Stability</label>
                            <input type="number" name="stability" value="{{ old('stability', $pet->stability) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-purple-500 transition-colors">
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-6 border-t border-gray-700/50">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        <div>
                            ...
                            <input type="number" name="hp" value="{{ old('hp', $pet->hp) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-emerald-500 transition-colors">
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Focus</label>
                            <input type="number" name="focus" value="{{ old('focus', $pet->focus) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-emerald-500 transition-colors">
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Calm</label>
                            <input type="number" name="calm" value="{{ old('calm', $pet->calm) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-emerald-500 transition-colors">
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Speed</label>
                            <input type="number" name="speed" value="{{ old('speed', $pet->speed) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-emerald-500 transition-colors">
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Balance</label>
                            <input type="number" name="balance" value="{{ old('balance', $pet->balance) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-emerald-500 transition-colors">
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Strength</label>
                            <input type="number" name="strength" value="{{ old('strength', $pet->strength) }}" placeholder="0" class="w-full bg-gray-900 focus:bg-gray-700 p-2.5 rounded text-white text-center border border-gray-700 focus:border-emerald-500 transition-colors">
                        </div>
                    </div>
                </div>
